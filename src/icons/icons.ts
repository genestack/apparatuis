...
export {DecimalIcon} from './decimal-icon';
export {DictionaryIcon} from './dictionary-icon';
export {DockBottomIcon} from './dock-bottom-icon';
export {DockRightIcon} from './dock-right-icon';
export {DownloadIcon} from './download-icon';
export {DraftIcon} from './draft-icon';
...
export {QuestionGhostIcon} from './question-ghost-icon';
