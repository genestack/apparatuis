...
import {TextareaAutosizeProps, default as TextareaAutosize} from 'react-textarea-autosize';
...
export interface Props extends TextareaAutosizeProps, WithClasses<keyof typeof styles> {
